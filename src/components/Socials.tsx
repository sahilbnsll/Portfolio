    ...
    <section className="flex gap-6">
      {socials.map((item) => (
        ...
        >
          ...
          <Icon name={item.icon} aria-hidden="true" className="size-5 transition-all duration-500 group-hover:scale-125 group-hover:drop-shadow-[0_0_6px_rgba(139,92,246,0.4)]" />
        </a>
      ))}
    </section>
  );
